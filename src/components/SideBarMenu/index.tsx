...
const SideBarMenu = ({ isOpenMenu, setIsOpenMenu }: PropsTypes) => {
	return (
		<div
			className={isOpenMenu ? styles.active : styles.wrapper}
		...
		>
			<div className={styles.head}>
				...
				<div className={styles.title}>sensei</div>
			</div>
			<ul className={styles.list}>
				...
				<li className={styles.item}>
					<img
						...
						alt="setsIcon"
					/>
					<Link to="/products/sets" className={styles.itemTitle}>
						Сеты
					</Link>
				</li>
				<li className={styles.item}>
					<img
						...
						alt="wokIcon"
					/>
					<Link to="/products/wok" className={styles.itemTitle}>
						Wok
					</Link>
				</li>
				<li className={styles.item}>
				...
				<li className={styles.item}>
					<img
						...
						alt="sushiIcon"
					/>
					<Link to="/products/sushi" className={styles.itemTitle}>
						Суши
					</Link>
				</li>
				<li className={styles.item}>
				...
				<li className={styles.item}>
					<img
						...
						alt="supsIcon"
					/>
					<Link to="/products/sups" className={styles.itemTitle}>
						Супы
					</Link>
				</li>
				<li className={styles.item}>
